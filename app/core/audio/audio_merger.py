...
class AudioMerger:
    ...
    def merge_audio_video(self, video_path: str, 
        ...
        try:
            # 构建FFmpeg命令
            cmd = self._build_merge_command(ffmpeg_path, video_path, audio_path, output_path, params)
    ...
    def _build_merge_command(self, ffmpeg_path: str,
                           video_path: str,
                           audio_path: str,
                           output_path: str,
    ...
    def replace_audio(self, video_path: str,
                     new_audio_path: str,
                     output_path: str,
                     **params) -> bool:
        """
    ...
    def merge_multiple_audio(self, video_path: str,
        ...
        try:
            # 构建多音频合并命令
            cmd = self._build_multi_audio_command(ffmpeg_path, video_path, audio_paths, output_path, params)
    ...
    def _build_multi_audio_command(self, ffmpeg_path: str,
                                 video_path: str,
                                 audio_paths: List[str],
                                 output_path: str,
                                 params: Dict[str, Any]) -> List[str]:
